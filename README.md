...
2. Install a Java Development Environment
    ...
    * IDEA's IntelliJ is good: https://www.jetbrains.com/idea/download/
...
4. Install spigot & craftbukkit into your maven repository:
    ...
    mvn install:install-file -Dfile=./spigot/spigot-1.8.7.jar -DgroupId=org.spigotmc -DartifactId=spigot -Dversion=1.8.7 -Dpackaging=jar

    mvn install:install-file -Dfile=./spigot/craftbukkit-1.8.7.jar -DgroupId=org.bukkit -DartifactId=craftbukkit -Dversion=1.8.7 -Dpackaging=jar
...
**THIS IS OLD, DON'T USE IT UNTIL I CAN UPDATE**
